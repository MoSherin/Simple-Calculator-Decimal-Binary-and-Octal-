...
# 1 "MCAL_Layer/GPIO/hal_gpio_cgf.h" 1
...
Std_ReturnType gpio_pin_direction_inti(const pin_config_t* pin_config){
    ...
    if(pin_config == ((void*)0) || pin_config->pin > 7)
    {
...
Std_ReturnType gpio_pin_get_direction_status(const pin_config_t* pin_config, direction_t *direction_status){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(pin_config == ((void*)0) || direction_status == ((void*)0) || pin_config->pin > 7)
    {
        ret = (Std_ReturnType)0x00;
    }
    else
...
uint8 gpio_pin_read_logic(const pin_config_t* pin_config){
    ...
    {
        return (((*port_register[pin_config->port] >> pin_config->pin) & 1));
    }
}
...
Std_ReturnType gpio_port_get_direction_status(port_index_t port, uint8 *direction_status){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(port > 4 || direction_status == ((void*)0))
    {
        ret = (Std_ReturnType)0x00;
    }
    else
...
# 276 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_port_toggle_logic(port_index_t port){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(port > 4)
    {
