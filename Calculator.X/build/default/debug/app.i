...
# 1 "./app.h" 1
# 13 "./app.h"
# 1 "./ECU-Layer/LED/ecu_led.h" 1
# 12 "./ECU-Layer/LED/ecu_led.h"
# 1 "./ECU-Layer/LED/../../MCAL_Layer/GPIO/hal_gpio.h" 1
# 13 "./ECU-Layer/LED/../../MCAL_Layer/GPIO/hal_gpio.h"
...
# 13 "./ECU-Layer/LED/../../MCAL_Layer/GPIO/hal_gpio.h" 2

# 1 "./ECU-Layer/LED/../../MCAL_Layer/GPIO/../mcal_std_types.h" 1
# 13 "./ECU-Layer/LED/../../MCAL_Layer/GPIO/../mcal_std_types.h"
# 1 "./ECU-Layer/LED/../../MCAL_Layer/GPIO/../std_libraries.h" 1
# 13 "./ECU-Layer/LED/../../MCAL_Layer/GPIO/../std_libraries.h"
...
# 13 "./ECU-Layer/LED/../../MCAL_Layer/GPIO/../std_libraries.h" 2
...
# 14 "./ECU-Layer/LED/../../MCAL_Layer/GPIO/../std_libraries.h" 2
...
# 15 "./ECU-Layer/LED/../../MCAL_Layer/GPIO/../std_libraries.h" 2
# 13 "./ECU-Layer/LED/../../MCAL_Layer/GPIO/../mcal_std_types.h" 2

# 1 "./ECU-Layer/LED/../../MCAL_Layer/GPIO/../compiler.h" 1
# 12 "./ECU-Layer/LED/../../MCAL_Layer/GPIO/../compiler.h"
...
# 12 "./ECU-Layer/LED/../../MCAL_Layer/GPIO/../compiler.h" 2
# 14 "./ECU-Layer/LED/../../MCAL_Layer/GPIO/../mcal_std_types.h" 2
# 35 "./ECU-Layer/LED/../../MCAL_Layer/GPIO/../mcal_std_types.h"
...
# 14 "./ECU-Layer/LED/../../MCAL_Layer/GPIO/hal_gpio.h" 2

# 1 "./ECU-Layer/LED/../../MCAL_Layer/GPIO/../device_config.h" 1
# 15 "./ECU-Layer/LED/../../MCAL_Layer/GPIO/hal_gpio.h" 2

# 1 "./ECU-Layer/LED/../../MCAL_Layer/GPIO/hal_gpio_cgf.h" 1
# 16 "./ECU-Layer/LED/../../MCAL_Layer/GPIO/hal_gpio.h" 2
# 36 "./ECU-Layer/LED/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
    LOW = 0,
    HIGH
}logic_t;
...
# 1 "./ECU-Layer/BUTTON/ecu_button.h" 1
# 18 "./ECU-Layer/BUTTON/ecu_button.h"
typedef enum{
    BUTTON_RELEASED = 0,
    BUTTON_PRESSED
}button_state_t;
...
# 1 "./ECU-Layer/KEYPAD/ecu_keypad.h" 1
...
button_t button = {.button_connection = BUTTON_ACTIVE_HIGH, .button_state = BUTTON_RELEASED, .button_pin.port = PORTB_INDEX, .button_pin.pin = PIN0, .button_pin.direction = INPUT, .button_pin.logic = LOW};
lcd_4bit_t lcd = {.Rs.pin = PIN4, .Rs.port = PORTC_INDEX, .Rs.direction = OUTPUT, .Rs.logic = LOW,.E.pin = PIN5, .E.port = PORTC_INDEX, .E.direction = OUTPUT, .E.logic = LOW, .Dx[0].pin = PIN0, .Dx[0].port = PORTC_INDEX, .Dx[0].direction = OUTPUT, .Dx[0].logic = LOW, .Dx[1].pin = PIN1, .Dx[1].port = PORTC_INDEX, .Dx[1].direction = OUTPUT, .Dx[1].logic = LOW, .Dx[2].pin = PIN2, .Dx[2].port = PORTC_INDEX, .Dx[2].direction = OUTPUT, .Dx[2].logic = LOW, .Dx[3].pin = PIN3, .Dx[3].port = PORTC_INDEX, .Dx[3].direction = OUTPUT, .Dx[3].logic = LOW};
...
int main() {
    ...
    while(1)
    {
        ...
        if(key)
        {
            if('=' == Operator)
            {
                Operator = 0; Num1 = 0; Num2 = 0; Num = 0;
                ret = lcd_4bit_send_command(&lcd, 0x01);
...
{
    uint64 temp = Num1;
    uint16 Dec1 = 0, Dec2 = 0;
    uint8 remainder = 0, i = 0;
    while(temp)
    {
      remainder = temp%10;
      temp /= 10;
